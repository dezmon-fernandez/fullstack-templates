...
Plan filename: `planning/[template-name].md`
...
Save as `planning/[template-name].md`. Each task needs:
...
- Plan saved to `planning/[template-name].md`
...
**Next step**: `/execute planning/[template-name].md`
